...
cross_compilers="gcc-arm-linux-gnueabihf gcc-aarch64-linux-gnu cpp-i686-linux-gnu"
...
if [ $TARGETPLATFORM == "linux/amd64" ]; then
  config_flags="--host=x86_64-linux-gnu "
elif [ $TARGETPLATFORM == "linux/i386" ]; then
  config_flags="--host=i686-linux-gnu "
elif [ $TARGETPLATFORM == "linux/arm64"  ]; then
  config_flags="--host=aarch64-linux-gnu "
elif [ $TARGETPLATFORM == "linux/arm/v7" ]; then
  config_flags="--host=armv7l-linux-gnu "
elif [ $TARGETPLATFORM == "linux/arm/v5" ]; then
  config_flags="--host=armv5-linux-gnu "
else
